...
class FaceRecognition:
    ...
    def save_detected_faces_info(self, file_path="C:/Users/abdul/depthai-python/examples/face recognition/data/detected_faces_info.txt"):
        ...
        for info in self.detected_faces_info:
            ...
            if confidence > 0.8:
                ...
                # Check if 20 seconds have passed since the last storage for this face name
        ...
        # Clear the detected_faces_info list after writing to the file
...
face_det_nn.setConfidenceThreshold(0.8)
    ...
    while True:
        ...
        if msgs is not None:
            ...
            for i, detection in enumerate(dets):
                ...
                facerec.detected_faces_info.append({"name": name, "id": id, "confidence": conf})
